...
$qry = " select tb_purchase.*, tb_goods.price as price, tb_goods.req_price as req_price, tb_goods.seq as seq, tb_goods.c24_product_no as c24_product_no from tb_purchase left join tb_goods on tb_purchase.seq = tb_goods.purchase_seq where seller = '".$s_seller."' and sellerphone = '".$s_sellerphone."' and birth = '".$s_birth."' and tb_goods.stock = 'Y' and tb_purchase.type = '위탁' ";
...
<body>
    <div class="list_wrapper">
	    ...
	    <div class="confirm_wrapper">
            <div class="guide">
   			· 가격수정은 기존판매가에서 5% 이상부터 하향 조정이 가능합니다.<br/>
   			· 가격수정으로인한 수수료 변동이 발생될 수 있으니 최종 수령금액을 꼭 확인해주시기 바랍니다.<br/>
			· 시스템상 표시된 정산예정금액이 계약내용과 다르게 표시되는 경우가 발생될 수 있습니다. 이경우 대표번호로 문의주시면 관련상담 도와드리겠습니다.<br/>
			· 품절 표기가 된 상태는 구매자분의 요청으로 상품예약 또는 온라인주문 후 구매확정/반품 선택중인 상태로 구매자분의 최종 구매확정이후 정산처리가 이루어집니다.<br/>
			· 품절 표기가 된 상태에선 위탁취소 요청이 불가합니다.<br/>
   			· 위탁접수일로부터 3개월 동안은 의무 위탁기간으로 위탁기간이내 회수 요청시 1개의 상품까지 무상 반환가능, 2개이상 상품부터 촬영및편집등 상품화 과정 과 상품 보관에 따른 위약금 30,000원이 별도 발생될 수 있습니다.<br/>
