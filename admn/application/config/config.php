...
$config['purchase_kind'] = array('시계','가방','지갑','반지','팔찌','목걸이','이어링','신발','백참/키링','스카프/머플러','의류','벨트','볼펜/만년필','선글라스','넥타이/커프링크스','모자/헤어악세사리','테이블웨어','ETC'); //매입 종류
...
$config['trade_selltype'] = array('매장판매','자체몰(N페이)','자체몰','필웨이','스토어팜','쿠팡','11번가','옥션','지마켓','구구스','위메프','인터파크','롯데온','티몬','머스트잇','톡스토어','트렌비','크림','시크먼트','GS','LF몰','현대H몰'); //판매구분
