...
<head>
   ...
   <script src="/admn/js/trade_modify2.js?<?=time()?>"></script>
</head>
<body>
   ...
   <div id="content">
      ...
      <div class="content_write">
			...
			<form class="form-horizontal" action="/admn/trade2/modifyproc?<?=$param?>" method="post" role="form" name="boardForm">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-7 pt2">
					 ...
					 <label class="account_conf_wrap">위탁확인 <input name="account_conf" type="radio" value="C"<?=($view->account_conf == 'C') ? ' checked="checked"' : ''?>></label>
                  </div>
               </div>
               <?php }?>
            	<div class="form-group">
