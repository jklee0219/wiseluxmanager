...
<head>
   ...
   <link rel="stylesheet" href="/admn/css/asinfo.css?<?=time()?>">
   <script>
   ...
   <script src="/admn/js/asinfo_write.js?v=4"></script>
</head>
<body>
	...
	<div id="content">
		...
		<div class="content_write">
			...
			<form class="form-horizontal" action="/admn/asinfo/writeproc?<?=$param?>" method="post" role="form" name="boardForm">
            	...
            	<div class="form-group">
               		...
               		<div class="col-sm-9 pt2">
                  		<input type='text' class='form-control input-sm' style="width:170px;display:inline-block" name="start_date" id='start_date' value=""> 
            	...
            	<div class="form-group">
               		...
               		<div class="col-sm-9 pt2">
                  		<textarea class='form-control input-sm' autocomplete="off" style="height:100px" name="reason" id="reason"></textarea>
               		</div>
            	</div>
            	<div class="form-group">
               		<label class="col-sm-3 control-label" for="end_date">마감날짜</label>
               		<div class="col-sm-9 pt2">
                  		<input type='text' class='form-control input-sm' style="width:170px;display:inline-block" name="end_date" id='end_date' value=""> 
            	...
            	<div class="form-group">
               		...
               		<div class="col-sm-9 pt2">
                  		<textarea class='form-control input-sm' autocomplete="off" style="height:100px" name="result" id="result"></textarea>
               		</div>
            	</div>
            	<div class="form-group">
