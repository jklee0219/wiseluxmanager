...
<body>
	...
	<div id="content">
		...
		<div class="content_write">
			...
			<form class="form-horizontal" action="/admn/trade/writeproc?<?=$param?>" method="post" role="form" name="boardForm">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-7 pt2">
                     ...
                     <label class="account_conf_wrap">계산서확인 <input name="account_conf" type="radio" value="C"></label>
                  </div>
               </div>
               <?php }?>
            	<div class="form-group">
