...
<head>
   ...
   <link rel="stylesheet" href="/admn/css/trade.css">
   <script>
   var qs = "<?=$param?>";
   ...
   <script src="/admn/js/trade_modify.js?<?=time()?>"></script>
</head>
<body>
   ...
   <div id="content">
      ...
      <div class="content_write">
			...
			<form class="form-horizontal" action="/admn/trade/modifyproc?<?=$param?>" method="post" role="form" name="boardForm">
            	...
            	<div class="form-group">
               		<label class="col-sm-3 control-label" for='purchase_pprice'>판매지급액</label>
               		<div class="col-sm-3 pt2">
            	...
            	<div class="form-group">
               		...
               		<div class="col-sm-3 pt2">
               			<div class="input-group date">
						    <input type="text" name="selldate" id="selldate" class="form-control input-sm" autocomplete="off" placeholder="" value="<?=$view->selldate?>">
						    <div class="input-group-addon input-sm">
						        <span class="glyphicon glyphicon-calendar"></span>
						    </div>
						</div>
            	...
            	<div class="form-group">
               		...
               		<div class="col-sm-3 pt2">
               			<select name="selltype" id="selltype" class="form-control input-sm">
							...
							<option value="<?=$v?>" <?=($view->selltype == $v) ? 'selected="selected"' : ''?>><?=$v?></option>
							<?php } ?>
	                  	</select>
               		</div>
            	</div>
            	...
            	<div class="form-group">
               		...
               		<div class="col-sm-4 pt2">
                  		<input type='text' class='form-control input-sm numcomma' name="amount" id='amount' value="<?=number_format($view->amount)?>">
               		</div>
            	</div>
            	 -->
               <div class="form-group">
                     ...
                     <div class="col-sm-4 pt2">
                        <input type='text' class='form-control input-sm numcomma' name="paymentprice" id='paymentprice' value="<?=number_format($view->paymentprice)?>">
                     </div>
               </div>
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-4 pt2">
                     <input type='text' class='form-control input-sm numcomma' autocomplete="off" name='payment_price_1' id='payment_price_1' maxlength="20" value="<?=number_format($view->payment_price_1)?>">
                  </div>
               </div>
               <div class="form-group">
                  <label class="col-sm-3 control-label" for="payment_price_2">무통장입금</label>
                  <div class="col-sm-4 pt2">
                     <input type='text' class='form-control input-sm numcomma' autocomplete="off" name='payment_price_2' id='payment_price_2' maxlength="20" value="<?=number_format($view->payment_price_2)?>">
                  </div>
               </div>
               <div class="form-group">
                  <label class="col-sm-3 control-label" for="payment_price_3">카드단말기</label>
                  <div class="col-sm-4 pt2">
                     <input type='text' class='form-control input-sm numcomma' autocomplete="off" name='payment_price_3' id='payment_price_3' maxlength="20" value="<?=number_format($view->payment_price_3)?>">
                  </div>
               </div>
               <div class="form-group">
                  <label class="col-sm-3 control-label" for="payment_price_4">온라인카드</label>
                  <div class="col-sm-4 pt2">
                     <input type='text' class='form-control input-sm numcomma' autocomplete="off" name='payment_price_4' id='payment_price_4' maxlength="20" value="<?=number_format($view->payment_price_4)?>">
                  </div>
               </div>
               <!--
			   <div class="form-group">
                  ...
                  <div class="col-sm-4 pt2">
                     <input type='text' class='form-control input-sm numcomma' autocomplete="off" name='npay' id='npay' maxlength="20" value="<?=number_format($view->npay)?>">
                  </div>
               </div>
			   -->
               <div class="form-group">
                  ...
                  <div class="col-sm-4 pt2">
                     <input type='text' class='form-control input-sm numcomma' autocomplete="off" name='payment_price_5' id='payment_price_5' maxlength="20" value="<?=number_format($view->payment_price_5)?>">
                  </div>
               </div>
            	...
            	<div class="form-group">
					...
					<div class="col-sm-4 pt2">
                  		<input type='text' class='form-control input-sm numcomma' autocomplete="off" name='sellprice' id='sellprice' maxlength="20" value="<?=number_format($view->sellprice)?>">
	               	</div>
            	</div>
            	<div class="form-group">
					<label class="col-sm-3 control-label" for="buyer">구매자</label>
					<div class="col-sm-3 pt2">
						<input type='text' class='form-control input-sm' autocomplete="off" name='buyer' id='buyer' maxlength="33" value="<?=$view->buyer?>">
	               	</div>
            	</div>
            	<div class="form-group">
               		...
               		<div class="col-sm-6 pt2" style="width:400px">
               			...
               			?>
                  		<input type='text' class='form-control input-sm onlynum' autocomplete="off" style="width:50px;display:inline-block;" name='buyerphone1' id="buyerphone1" maxlength="4" placeholder="" value="<?=$buyerphone1?>"> -
                  		<input type='text' class='form-control input-sm onlynum' autocomplete="off" style="width:60px;display:inline-block;" name='buyerphone2' id="buyerphone2" maxlength="4" placeholder="" value="<?=$buyerphone2?>"> -
                  		<input type='text' class='form-control input-sm onlynum' autocomplete="off" style="width:60px;display:inline-block;" name='buyerphone3' id="buyerphone3" maxlength="4" placeholder="" value="<?=$buyerphone3?>">
               		</div>
            	</div>
            	<div class="form-group">
					<label class="col-sm-3 control-label" for="dc">적립금사용</label>
					<div class="col-sm-3 pt2">
						<input type='text' class='form-control input-sm onlynum' autocomplete="off" name='dc' id='dc' maxlength="10" value="<?=$view->dc?>">
	               	</div>
            	</div>
            	<div class="form-group">
					<label class="col-sm-3 control-label" for="sellerinfo">구매자정보</label>
					<div class="col-sm-7 pt2">
						<input type='text' class='form-control input-sm' autocomplete="off" name=sellerinfo id='sellerinfo' maxlength="50" value="<?=$view->sellerinfo?>">
	               	</div>
            	</div>
               ...
               <div class="form-group">
                     ...
                     <div class="col-sm-3 pt2">
                        <div class="input-group date">
                      <input type="text" name="senddate" class="form-control input-sm" autocomplete="off" placeholder="" value="<?=$view->senddate?>">
                      <div class="input-group-addon input-sm">
                          <span class="glyphicon glyphicon-calendar"></span>
                      </div>
                  </div>
               ...
               <?php }?>
            	<div class="form-group">
               		...
               		<div class="col-sm-9 pt2">
                  		<textarea class='form-control input-sm' autocomplete="off" style="height:100px" name="note" id="note"><?=$view->note?></textarea>
               		</div>
            	</div>
         	</form>
         	...
         	<div class="content_bottom">
            	<div class="content_left">
	                ...
	                <button type="button" data-seq="<?=$view->seq?>" class="board_delete_btn btn btn-danger btn-sm"><i class="glyphicon glyphicon-trash"></i> 삭제</button>
               		<button type="button" class="board_cancel_btn btn btn-warning btn-sm" onclick="document.location.href='/admn/trade?<?=$param?>'" type="button"><i class="glyphicon glyphicon-remove"></i> 취소</button>
            	</div>
         	</div>
