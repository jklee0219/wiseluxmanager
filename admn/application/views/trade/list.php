...
<head>
   ...
   <script src="/admn/js/trade.js?<?=time()?>"></script>
   <script>
   var qs = "<?=$param?>";
   </script>
</head>
         	...
         	<div class="content_top">
            	...
            	<div>
            		<div class="amount_info_wrap">
               		...
               		<form name="searchFrm" action="/admn/trade" method="get">
               			<div style="margin-bottom:6px">
               				<select class="form-control input-sm" name="smmpricecol" id="smmpricecol">
								...
								<option value="pprice" <?=($smmpricecol=='pprice') ? "selected='selected'" : ""?>>판매지급액</option>
								<?php } ?>
							</select>
                        ...
                        <?php }?>
                  		<button type="button" onclick="location.href='./trade/write?<?=$param?>'" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-pencil"></i> 등록</button>
                  		<p class="line"></p>
               		</form>
				</div>
         	</div>
	            ...
	            <table class="table">
	               ...
	               ?>
	                  <tr<?=$trclass?>>
	                     ...
	                     <td><?=$buyerphone?></td>
	                     <td>
	                     	<button type="button" onclick="location.href='/admn/trade/modify?seq=<?=$seq?>&<?=$param?>'" style="width:83px" class="btn btn-primary btn-sm"><i class="glyphicon glyphicon-wrench"></i> 거래수정</button><br/>
	                     	<?php if($goods_seq){ ?>
