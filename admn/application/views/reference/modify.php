...
<head>
   ...
   <script src="/admn/js/reference_modify.js?<?=time()?>"></script>
</head>
<body>
			...
			<form class="form-horizontal" action="/admn/reference/modifyproc?<?=$param?>" method="post" role="form" name="boardForm">
            	...
            	<div class="form-group">
               		...
               		<div class="col-sm-9 pt2">
                  		<input type='text' class='form-control input-sm' autocomplete="off" name='title' id="title" maxlength="330" value="<?=$view->title?>">
               		</div>
            	</div>
            	<div class="form-group">
               		<label class="col-sm-2 control-label" for="writer">작성자<?=$required_mark?></label>
               		<div class="col-sm-3 pt2">
                  		<input type='text' class='form-control input-sm' autocomplete="off" name='writer' id="writer" maxlength="50" value="<?=$view->writer?>">
               		</div>
            	</div>
            	<div class="form-group">
               		...
               		<div class="col-sm-3 pt2">
						<select name="category" id="category" class="form-control input-sm">
							...
							<option value="<?=$v?>" <?=($view->category == $v) ? 'selected="selected"' : ''?>><?=$v?></option>
							<?php }?>
	                  	</select>
	               	</div>
            	</div>
            	<div class="form-group">
					...
					<div class="col-sm-10 pt2">
						<textarea class='form-control input-sm textarea' autocomplete="off" name="content" id="content_editor"><?=$view->content?></textarea>
	               	</div>
            	</div>
            	<div class="form-group">
               		<label class="col-sm-2 control-label" for="note">비고</label>
               		<div class="col-sm-9 pt2">
                  		<input type='text' class='form-control input-sm' autocomplete="off" name='note' id="note" maxlength="200" value="<?=$view->note?>">
               		</div>
            	</div>
         	</form>
