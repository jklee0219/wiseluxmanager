...
<div class="navbar-inverse navbar-fixed-left">
  <ul class="nav">
   ...
   <li><a href="/admn/attendance" class="waves-effect<?=($this->uri->segment(2)=='attendance') ? 'active' : ''?>"><i class="glyphicon glyphicon-ok"></i> 근무현황<i class="glyphicon glyphicon-menu-right pull-right"></i></a></li>
