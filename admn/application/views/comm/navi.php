...
<div class="navbar-inverse navbar-fixed-left">
  <ul class="nav">
   ...
   <li><a href="/admn/refund" class="waves-effect<?=stripos($_SERVER['PHP_SELF'],'refund')!==false ? ' active' : ''?>"><i class="glyphicon glyphicon-sort"></i> 반품목록<i class="glyphicon glyphicon-menu-right pull-right"></i></a></li>
   <li><a href="/admn/productmvdate" class="waves-effect<?=stripos($_SERVER['PHP_SELF'],'productmvdate')!==false ? ' active' : ''?>"><i class="glyphicon glyphicon-duplicate"></i> 상품이동일정<i class="glyphicon glyphicon-menu-right pull-right"></i></a></li>
