...
<head>
   ...
   <script src="/admn/js/goodsmove_write.js?v=1"></script>
</head>
<body>
	...
	<div id="content">
		...
		<div class="content_write">
			...
			<form class="form-horizontal" action="/admn/productmove/writeproc?<?=$param?>" method="post" role="form" name="boardForm">
            	...
            	<div class="form-group">
               		...
               		<div class="col-sm-3 pt2">
                  		<div class="input-group date">
                            <input type="text" name='shipdate' id='shipdate' class="form-control input-sm" autocomplete="off" placeholder="" value="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3 pt2">
                        <div class="input-group date">
                            <input type="text" name='recivedate' id='recivedate' class="form-control input-sm" autocomplete="off" placeholder="" value="">
                            <div class="input-group-addon input-sm">
                                <span class="glyphicon glyphicon-calendar"></span>
                            </div>
                        </div>
