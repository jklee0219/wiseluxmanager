<?php
class Trade_model2 extends CI_Model
{
  ...
  function getList($condition,$scale="N",$first="0")
  {
    $selectcolumn = "
      ...
      tb_purchase.paymethod as paymethod2,
  		pprice,
  		stock,
    ...
    if(isset($condition['spaymethod2'])) $this->db->where("tb_purchase.paymethod", $condition['spaymethod2']=='empty' ? '' : $condition['spaymethod2']);
    ...
    $this->db->where_in('type', array('위탁'));
