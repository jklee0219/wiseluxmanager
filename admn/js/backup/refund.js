$(document).ready(function(){
	...
	$('input[name="ssapplydate"]').datepicker({
		format: "yyyy-mm-dd",
	    language: "ko"
    }).on("changeDate", function (e) {
    	var dt = new Date(e.date.valueOf());
    	$('input[name="seapplydate"]').datepicker('setStartDate', dt);
    });
	
	$('input[name="seapplydate"]').datepicker({
		format: "yyyy-mm-dd",
	    language: "ko"
    }).on("changeDate", function (e) {
    	var dt = new Date(e.date.valueOf());
    	$('input[name="ssapplydate"]').datepicker('setEndDate', dt);
    });
	
	$('input[name="sscompletedate"]').datepicker({
		format: "yyyy-mm-dd",
	    language: "ko"
    }).on("changeDate", function (e) {
    	var dt = new Date(e.date.valueOf());
    	$('input[name="secompletedate"]').datepicker('setStartDate', dt);
    });
	
	$('input[name="secompletedate"]').datepicker({
		format: "yyyy-mm-dd",
	    language: "ko"
    }).on("changeDate", function (e) {
    	var dt = new Date(e.date.valueOf());
    	$('input[name="sscompletedate"]').datepicker('setEndDate', dt);
    });
	...
	$('#excel_btn').click(function(){
		$('iframe[name="hiddenFrm"]').attr('src','/admn/refund/excel?'+qs);
	});
});